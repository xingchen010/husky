...
import com.husky.config.CustomizedPropertyConfigurer;
import com.melo.focus.realm.AuthShiroRealm;

@Configuration
@ImportResource("classpath:spring/spring-shiro.xml")
//@ConfigurationProperties(prefix = "redis")
//@PropertySource("config/redisConfig.properties")
...
//		shiroFilterFactoryBean.setUnauthorizedUrl("/403");
	...
	public SecurityManager securityManager() {
		...
		// 用了redis缓存注入安全管理器，会报一个序列化失败的错误，推测是new SimpleAuthenticationInfo 时
		// user对象无法序列化，加上序列化就好了
		...
		String hostName = CustomizedPropertyConfigurer.getCtxProp("redis.hostName");
	...
	/**
	 * 配置shiro redisManager 网上的一个 shiro-redis 插件，实现了shiro的cache接口、CacheManager接口就
	 * 
	 * @return
	 */
/*	@Bean
	...
	/**
	 * cacheManager 缓存 redis实现 网上的一个 shiro-redis 插件
	 * 
	 * @return
	 */
	@Bean
